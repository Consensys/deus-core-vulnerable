...
const { impersonate, transfer, setBalance, getBalanceOf } = require('./helpers/modify_chain');
...
async function main() {
    ...
    const wrappedNativeTokenAddress = "0x4200000000000000000000000000000000000006"; // Wrapped eth
    const usdcAddress = "0x7f5c764cbc14f9669b88837ca1490cca17c31607"; // USDC decimal: 6
    const routerAddress = ""; // Nothing !
    ...
    // await impersonate(process.env.DEI_DEPLOYER);
    // await impersonate(process.env.DEUS_DEPLOYER);
    ...
    const stakingDEI_DEUS = await deployStaking({
        stakeTokenAddress: "0x0000000000000000000000000000000000000001",
