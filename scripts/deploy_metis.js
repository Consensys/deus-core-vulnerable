...
async function main() {
    ...
    const wrappedNativeTokenAddress = "0x75cb093E4D61d2A2e65D8e0BBb01DE8d89b53481"; // Wrapped Native Token
    const usdcAddress = "0xEA32A96608495e54156Ae48931A7c20f0dcc1a21"; // USDC decimal: 6
    const routerAddress = '0x1E876cCe41B7b844FDe09E38Fa1cf00f213bFf56'; // UniswapV2Router02 (netswap)
    ...
    // Pairing
    const deiInDei_Deus = BigInt(0.1e18)
    const deusInDei_Deus = BigInt(0.1e18)

    const deiInDei_USDC = BigInt(0.1e18)
    const USDCInDei_USDC = BigInt(0.1e6)

    const NativeTokenInDeus_NativeToken = BigInt(0.1e18);
    const deusInDeus_NativeToken = BigInt(0.1e18);
