...
async function main() {
    ...
    const wrappedNativeTokenAddress = "0x82af49447d8a07e3bd95bd0d56f35241523fbab1"; // Wrapped eth
    const usdcAddress = "0xFF970A61A04b1cA14834A43f5dE4533eBDDB5CC8"; // USDC decimal: 6
    const routerAddress = "0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506"; // Sushi Swap

    const creatorAddress = process.env.MAIN_DEPLOYER;
    const USDCPoolCeiling = 20e6 * 1e6;
    ...
    const contracts = [
        {
            ...
            constructorArguments: ["DEI", "DEI", process.env.MAIN_DEPLOYER],
            verified: true
        },
        {
            address: '0xDE5ed76E7c05eC5e4572CfC88d1ACEA165109E44',
            constructorArguments: ["DEUS", "DEUS", process.env.MAIN_DEPLOYER],
            verified: true
        },
        {
            address: '0x3967e99B02d86ffc84fb69Fd9a7C136952906201',
            constructorArguments: [process.env.MAIN_DEPLOYER, "1", process.env.MAIN_DEPLOYER],
            verified: true
        },
        {
            address: '0xc63eAf6BC162531b153Dfc61F225E62d2edB4488',
            constructorArguments: [],
            verified: true
        },
        {
            address: '0xa0F395aD5df1Fceb319e162CCf1Ef6645dE8508f',
            constructorArguments: [
                ...
                process.env.MAIN_DEPLOYER,
                20e6 * 1e6,
                '0xc63eAf6BC162531b153Dfc61F225E62d2edB4488'
            ],
            verified: true
        },
        {
            address: '0xCbcdFF7E0779F25d7a72C243ac8C25410c67Dbd2',
            constructorArguments: [
                '0xDE12c7959E1a72bbe8a5f7A1dc8f8EeF9Ab011B3',
                '0xDE5ed76E7c05eC5e4572CfC88d1ACEA165109E44'
            ],
        ...
        {
            address: '0x4e5D8794f08F2792DC51016d0a4b9A205cAFc63A',
            constructorArguments: [
                '0x9444937604f8e95db2A8895DD7E119CAF1238f01',
                '0xDE5ed76E7c05eC5e4572CfC88d1ACEA165109E44',
                rewardPerBlock,
                daoShare,
                foundersShare,
        ...
        {
            address: '0xa78Ea447ce5AA4669A5f0cD8D27bF5883E1Bf20f',
            constructorArguments: [
                '0xe3d676DF35e1d98a8504b9C01Ad302d5ebaDf0f9',
                '0xDE5ed76E7c05eC5e4572CfC88d1ACEA165109E44',
                rewardPerBlock,
                daoShare,
                foundersShare,
