...
contract DEIPool is AccessControl, Owned {
    ...
    function mint1t1DEI(uint256 collateral_amount, uint256 DEI_out_min)
        external
        notMintPaused
    {
    ...
    function mintAlgorithmicDEI(
        ...
        DEI.verify_price(deus_current_price, expireBlock, sigs);
        require(
    ...
    function redeem1t1DEI(uint256 DEI_amount, uint256 COLLATERAL_out_min)
        external
        notRedeemPaused
    {
        require(
